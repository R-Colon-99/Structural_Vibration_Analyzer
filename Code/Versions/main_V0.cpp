// ESP32 Main code for data collection from MPU6050 IMU at 500 Hz with calibration and CSV output over serial.
// Uses I2C communication with the MPU6050 and outputs calibrated accelerometer and gyroscope data in CSV format for easy analysis.
